...
BLOG_AUTHOR = "Roie R. Black"  # (translatable)
BLOG_TITLE = "Black-DevOps"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://blog.black-devops.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://blog.black-devops.org/"
BLOG_EMAIL = "rblack@austincc.edu"
BLOG_DESCRIPTION = "Technology Blog"  # (translatable)
